  ...
  <nav class="site-nav">
    <div class="flex-container">
      <div class="logo-container">
        <router-link to="/">
        <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 566" preserveAspectRatio="xMinYMin meet">
          <path d="M197.28 548.749l5.427-90.43 14.985-25.58s-34.106 13.952-91.205 13.952c-57.1 0-90.689-13.694-90.689-13.694l16.794 27.904 5.941 87.848c0 9.418 31.059 17.052 69.374 17.052 38.313 0 69.373-7.634 69.373-17.052M180.161 126.454l11.391-45.025 63.081-66.376L238.007.892l-66.784 70.707-13.226 53.793a886.14 886.14 0 0 0-29.873-.497c-70.336 0-127.355 8.016-127.355 17.902 0 9.887 57.019 17.902 127.355 17.902 70.335 0 127.353-8.015 127.353-17.902 0-7.28-30.924-13.546-75.316-16.343" fill="#D34A47"/>
          <path d="M173.535 151.669s-2.467.553-9.724.584c-7.259.03-12.413-.047-14.466-1.917-.552-.502-.854-1.499-.851-2.174.006-1.285.918-2.042 2.08-2.516l1.099 1.724c-.478.165-.751.36-.752.568-.004.976 7.422 1.644 13.102 1.572 5.681-.07 12.545-.538 12.551-1.5 0-.291-.519-.565-1.422-.781l1.094-1.712c1.472.457 2.757 1.34 2.754 2.868-.014 2.598-3.32 2.993-5.465 3.284" fill="#FFF"/>
          ...
          <!-- <img class="logo" src="~@/assets/gulp.svg" alt="gulp-desktop"> -->
        </router-link>
      </div>
      <div class="nav-container">
        <ul>
          ...
          <li>
            <router-link to="/configs" active-class="router-link-active">
              <i class="fa fa-gears"></i> <span>Configs</span>
            </router-link>
          </li>
          <li>
            <router-link to="/marketplace" active-class="router-link-active">
              <i class="fa fa-shopping-bag"></i> <span>Marketplace</span>
            </router-link>
          </li>
          <li>
            <router-link to="/settings" active-class="router-link-active">
              <i class="fa fa-wrench"></i> <span>Settings</span>
            </router-link>
          </li>
          <li>
            <router-link to="/help">
              <i class="fa fa-question-circle-o" active-class="router-link-active"></i> <span>Help</span>
            </router-link>
          </li>
        </ul>
      </div>
...
.nav-container {
  ...
  a {
    display: block;
    padding: 1em 0;
    color: $textWhite; background: $brand-primary;
